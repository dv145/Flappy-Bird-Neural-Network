...
def update_data_labels(gameDisplay, dt, game_time, num_iterations, num_alive, best_time, font):
    y_pos = 10
    gap = 20
    x_pos = 10
    ...
    y_pos = update_label(round(best_time/1000,2),'Best Time', font, x_pos, y_pos + gap, gameDisplay)
...
def run_game():
    ...
    while running:
        ...
        update_data_labels(gameDisplay, dt, game_time, num_iterations, num_alive, best_time, label_font)
